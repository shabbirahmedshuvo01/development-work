...
const Section = () => {
    ...
    return (
        <div className='mx-20 my-10 lg:flex shadow-2xl p-10'>

            <div>
                <div>
                    <p className='font-semibold text-xl text-start'>In this 5 day class we will explore artists Monet, Matisse, Van <br /> Gogh, among others and then recreate paintings using crayon <br /> and watercolor. Students will have fun learning about the artists <br /> & creating their own art inspired by their work.</p>
                </div>
                ...
                <h2 className='font-semibold text-xl mt-3 pl-2 text-start'>Completed by 21 learners</h2>
